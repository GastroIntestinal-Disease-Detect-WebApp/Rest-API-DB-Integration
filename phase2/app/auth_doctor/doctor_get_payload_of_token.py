...
from auth_doctor.doctor_jwt_token_verification import verify_token
from auth_doctor.doctor_singleton_pub_key import ClassicSingleton


async def doctor_get_payload_of_jwt_token(authorization: str = Header(None)):
